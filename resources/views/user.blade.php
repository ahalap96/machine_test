      ...
      <div class="container">
         <div class="menu_main">
            <ul>
               ...
               <li class="dropdown"><a href="#"><span>Add complaints</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="{{route('ksebcmp')}}">Kseb</a></li>
              <li><a href="{{route('watercmp')}}">water authority</a></li>
              <li><a href="{{route('transcmp')}}">transportation</a></li>
            </ul>
          </li>
               <li><a href="{{route('userviewcmp')}}">view complaints</a></li>
               <li class="dropdown"><a href="#"><span>complaints by department</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="">Kseb</a></li>
              <li><a href="">water authority</a></li>
