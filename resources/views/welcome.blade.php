...
<body>
   ...
   <div class="costume_header">
      <div class="container">
         <div class="menu_main">
            <ul>
               <li><a href="{{route('adddept')}}">Add department</a></li>
               <li><a href="{{route('addemp')}}">Add employees</a></li>
               <li><a href="{{route('viewcomplaint')}}">view complaints</a></li>
               <li class="dropdown"><a href="#"><span>complaints by department</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="{{route('viewksebcmp')}}">Kseb</a></li>
              <li><a href="{{route('viewwatercmp')}}">water authority</a></li>
              <li><a href="{{route('viewtranscmp')}}">transportation</a></li>
              
            </ul>
          </li>
          <li class="dropdown"><a href="#"><span>complaints by date</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="">Kseb</a></li>
